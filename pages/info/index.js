...
export default function Info() {
   let mySid = "6410742495";
   let myFirstname = "Viphava";
   let myLastname = "Khlaisuwan";
...
<div>CN334 Frontend By 6410742495 Viphava Khlaisuwan </div>
<Link href="info/product/123">
<button className='m-1 p-4 bg-blue-400 rounded-3xl'>Product 123</button>
</Link>
<Link href={`info/product/${id_from_variable}`}>
